...
[정적 관리자 사용 안내]
- admin.html에서 문구, 메인 사진, 객실, 이용 안내, 팝업을 수정할 수 있습니다.
- 팝업을 여러 개 추가하거나 삭제할 수 있으며 각 팝업마다 사진과 문구를 설정할 수 있습니다.
- 방문자는 각 팝업에서 '오늘 하루 보지 않기'를 선택할 수 있습니다.
- 저장 내용은 현재 브라우저에 보관되며 같은 브라우저의 홈페이지에 즉시 적용됩니다.
- GitHub Pages는 서버와 데이터베이스가 없는 정적 서비스이므로 관리자 변경 내용이 다른 방문자에게 자동 배포되지는 않습니다.
- 설정 백업/불러오기 기능으로 수정 내용을 파일로 옮길 수 있습니다.
- 여러 기기에 공통으로 즉시 반영되는 관리자가 필요하면 별도의 데이터베이스 또는 CMS 연결이 필요합니다.
- 관리자 로그인 아이디: iamch94
